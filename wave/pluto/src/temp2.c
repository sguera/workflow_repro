...
if(t5 % 3 == 0) {                for (t8=lbv;t8<=ubv;t8++) {
                  u[2][-2*t5+t6][-2*t5+t7][-2*t5+t8]=c0*u[1][-2*t5+t6][-2*t5+t7][-2*t5+t8]-u[0][-2*t5+t6][-2*t5+t7][-2*t5+t8]+c1*(u[1][-2*t5+t6+1][-2*t5+t7][-2*t5+t8]+u[1][-2*t5+t6-1][-2*t5+t7][-2*t5+t8]+u[1][-2*t5+t6][-2*t5+t7+1][-2*t5+t8]+u[1][-2*t5+t6][-2*t5+t7-1][-2*t5+t8]+u[1][-2*t5+t6][-2*t5+t7][-2*t5+t8-1]+u[1][-2*t5+t6][-2*t5+t7][-2*t5+t8+1])+c2*(u[1][-2*t5+t6+2][-2*t5+t7][-2*t5+t8]+u[1][-2*t5+t6-2][-2*t5+t7][-2*t5+t8]+u[1][-2*t5+t6][-2*t5+t7+2][-2*t5+t8]+u[1][-2*t5+t6][-2*t5+t7-2][-2*t5+t8]+u[1][-2*t5+t6][-2*t5+t7][-2*t5+t8-2]+u[1][-2*t5+t6][-2*t5+t7][-2*t5+t8+2]);;
                }
} else if(t5 % 3 == 1) {
                for (t8=lbv;t8<=ubv;t8++) {
                  u[0][-2*t5+t6][-2*t5+t7][-2*t5+t8]=c0*u[2][-2*t5+t6][-2*t5+t7][-2*t5+t8]-u[1][-2*t5+t6][-2*t5+t7][-2*t5+t8]+c1*(u[2][-2*t5+t6+1][-2*t5+t7][-2*t5+t8]+u[2][-2*t5+t6-1][-2*t5+t7][-2*t5+t8]+u[2][-2*t5+t6][-2*t5+t7+1][-2*t5+t8]+u[2][-2*t5+t6][-2*t5+t7-1][-2*t5+t8]+u[2][-2*t5+t6][-2*t5+t7][-2*t5+t8-1]+u[2][-2*t5+t6][-2*t5+t7][-2*t5+t8+1])+c2*(u[2][-2*t5+t6+2][-2*t5+t7][-2*t5+t8]+u[2][-2*t5+t6-2][-2*t5+t7][-2*t5+t8]+u[2][-2*t5+t6][-2*t5+t7+2][-2*t5+t8]+u[2][-2*t5+t6][-2*t5+t7-2][-2*t5+t8]+u[2][-2*t5+t6][-2*t5+t7][-2*t5+t8-2]+u[2][-2*t5+t6][-2*t5+t7][-2*t5+t8+2]);;
                }
} else {
                for (t8=lbv;t8<=ubv;t8++) {
                  u[1][-2*t5+t6][-2*t5+t7][-2*t5+t8]=c0*u[0][-2*t5+t6][-2*t5+t7][-2*t5+t8]-u[2][-2*t5+t6][-2*t5+t7][-2*t5+t8]+c1*(u[0][-2*t5+t6+1][-2*t5+t7][-2*t5+t8]+u[0][-2*t5+t6-1][-2*t5+t7][-2*t5+t8]+u[0][-2*t5+t6][-2*t5+t7+1][-2*t5+t8]+u[0][-2*t5+t6][-2*t5+t7-1][-2*t5+t8]+u[0][-2*t5+t6][-2*t5+t7][-2*t5+t8-1]+u[0][-2*t5+t6][-2*t5+t7][-2*t5+t8+1])+c2*(u[0][-2*t5+t6+2][-2*t5+t7][-2*t5+t8]+u[0][-2*t5+t6-2][-2*t5+t7][-2*t5+t8]+u[0][-2*t5+t6][-2*t5+t7+2][-2*t5+t8]+u[0][-2*t5+t6][-2*t5+t7-2][-2*t5+t8]+u[0][-2*t5+t6][-2*t5+t7][-2*t5+t8-2]+u[0][-2*t5+t6][-2*t5+t7][-2*t5+t8+2]);;
                }
}              }
            }
          }
